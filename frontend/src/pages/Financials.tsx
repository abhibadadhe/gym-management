    ...
    <div className="space-y-6 pb-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="glass-panel p-5 rounded-3xl space-y-2 shadow-sm">
          ...
          <span className="text-[11px] text-slate-400 block">Total fees collected</span>
        </div>
        ...
        <div className="glass-panel p-5 rounded-3xl space-y-2 shadow-sm">
          ...
          <span className="text-[11px] text-slate-400 block">Operating expenditures</span>
        </div>
        ...
        <div className="glass-panel p-5 rounded-3xl space-y-2 shadow-sm">
          ...
          <span className="text-[11px] text-slate-400 block">Revenue minus Expenses</span>
        </div>
